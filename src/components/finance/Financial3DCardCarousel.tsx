      ...
      <div className="relative w-full h-[330px] flex items-center justify-center perspective-1000 overflow-hidden py-2 select-none">
        ...
        <div 
          ...
          className={`absolute transition-all duration-500 ease-out cursor-pointer ${
            activeCardIndex === 0
              ? 'z-30 scale-100 translate-x-0 opacity-100 shadow-xl'
              : 'z-10 scale-90 -translate-x-[110px] opacity-75 blur-[0.3px] hover:opacity-90'
          }`}
          style={{ width: '270px' }}
        >
          <div className="bg-gradient-to-br from-slate-50 to-white rounded-3xl p-5 border border-slate-200 shadow-md h-[305px] flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-slate-400">Зароблено</span>
              ...
              <div className="text-2xl font-black text-slate-900 mt-1">₴ 12 460</div>
              
              {/* Micro Bar Chart Visual */}
              <div className="mt-4 flex items-end gap-2 h-18 pt-2">
                <div className="w-4 bg-blue-100 rounded-t-sm h-6" />
                <div className="w-4 bg-blue-200 rounded-t-sm h-9" />
                <div className="w-4 bg-blue-300 rounded-t-sm h-12" />
                <div className="w-4 bg-blue-400 rounded-t-sm h-8" />
                <div className="w-4 bg-blue-500 rounded-t-sm h-14" />
                <div className="w-4 bg-blue-600 rounded-t-sm h-16" />
                <div className="w-4 bg-emerald-500 rounded-t-sm h-18" />
              </div>
            </div>

            <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-xs text-slate-400">
              <span>Цей місяць</span>
              <span className="text-blue-600 font-bold">Деталі →</span>
            </div>
          </div>
        </div>
        ...
        <div 
          ...
          className={`absolute transition-all duration-500 ease-out cursor-pointer ${
            activeCardIndex === 1
              ? 'z-30 scale-100 translate-x-0 opacity-100 shadow-[0_12px_32px_rgba(0,0,0,0.08)]'
              : activeCardIndex === 0
          ...
          style={{ width: '280px' }}
        >
          <div className="bg-white rounded-3xl p-5 border border-slate-100 shadow-lg h-[310px] flex flex-col justify-between relative overflow-hidden">
            
            {/* Top Light Accent */}
            <div className="absolute -top-10 -right-10 w-28 h-28 bg-blue-100/50 rounded-full blur-xl pointer-events-none" />

            <div>
              {/* Header: Label + 3D Gold Coins Graphic */}
              <div className="flex items-start justify-between">
                <div>
                  <span className="text-xs font-semibold text-slate-400">Баланс</span>
              ...
              <div className="space-y-1.5 mt-3 text-xs">
                <div className="flex items-center justify-between text-slate-500">
                  <span>Доступно</span>
                  <span className="font-bold text-slate-900">₴ 4 230</span>
                </div>
                <div className="flex items-center justify-between text-slate-500">
                  <span>Очікує</span>
                  <span className="font-bold text-slate-900">₴ 3 650</span>
                </div>
                <div className="flex items-center justify-between text-slate-500">
                  <span>Утримано</span>
                  <span className="font-bold text-slate-900">₴ 580</span>
                </div>
              </div>

              {/* Gold 20% Pill Badge */}
              <div className="mt-3">
                <span className="px-2.5 py-1 rounded-full bg-amber-50 text-amber-800 border border-amber-200/80 text-[11px] font-bold inline-flex items-center gap-1.5">
        ...
        >
          <div className="bg-gradient-to-br from-slate-50 to-white rounded-3xl p-5 border border-slate-200 shadow-md h-[305px] flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-slate-400">Доступно до виводу</span>
                <span className="text-lg">💳</span>
              </div>
              <div className="text-2xl font-black text-slate-900 mt-1">₴ 4 230</div>
              <p className="text-[11px] text-slate-400 mt-2">
                Мінімальна сума для виплати на IBAN або картку: <span className="font-bold text-slate-700">₴ 1 000</span>
              </p>
            </div>
